...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        default=('/home/will/Desktop/Thesis/open-mmlab/mmaction2/work_dirs/slowonly_r50_u48_240e_ntu120_xsub_keypoint_v1/slowonly_r50_u48_240e_ntu120_xsub_keypoint_v101.py'),
        help='skeleton model config file path')
    #set the path of checkpoint
    parser.add_argument(
        '--checkpoint',
        default=('/home/will/Desktop/Thesis/open-mmlab/mmaction2/work_dirs/slowonly_r50_u48_240e_ntu120_xsub_keypoint_v1/best_top1_acc_epoch_160.pth'),
        help='skeleton model checkpoint file/url')
    #set the path of label map
    parser.add_argument(
        '--label-map',
        default='/home/will/Desktop/Thesis/open-mmlab/mmaction2/tools/data/skeleton/label_map.txt',
        help='label map file')
    parser.add_argument(
